Разработка Мародера [2014.01.03 .. 2014.02.23]
##############################################
...
Есть тестовая модель (вроде как танка), слепленная в блендере за пару минут
и покрашенная там же, что бы проверить, как натягиваются текстуры:
...
[ВСТАВИТЬ СЮДА "wc -l \*.rs" по всем файлам в нужной версии]
...
Исходники хранятся на гитхабе (ССЫЛКА), для текстур и моделей отдельный
репозиторий - (ССЫЛКА).
