...
This release add adds [~2k lines of code][tokei] - a lot of new features!
...
I hope that they won't cause too many problems for you.

## Simple walking animation

Ok, the first and the simplest change is simple walking animations.
Compare:

![no animation](images/2018-02-24-move-pre.gif)
![new arc animation](images/2018-02-24-move-now.gif)

That's a small visual improvement but it makes the game a little bit more alive.
...
Each active ability usage requires either Attack (red) or Jokers (purple) point
and can trigger enemy's reaction attack.

Most abilities have cooldowns of 2 or 3 turns.

Passive abilities are don't require action points
activate automatically during attacks or at the begining of the turn.

Exact a abilities are explained in corresponding unit sections.

### New Unit: Toxic Imp

This enemy is similar to basic Imp, but
does no direct damage and has a **Poison Attack** passive ability.
Has also no reaction attacks as he's dangerous enough without them)

![toxic imp demo](images/2018-02-24-imp-poison.gif)

Poison lasts for 2 turns.
Reduce attacks of poisoned unit by one.

### New Unit: Imp-Bomber

One obvious problem of v0.3 was [turtling](TODO: link to Keith article) -
no movement, boring.
...
is to rush and attack it while summoned imps are still weak.

**Summons** ability summons three imps of random type.
...
Basically, Summoners are your main targets.
...
[![TODO: remove](https://i.imgur.com/LyO86w3.png)](https://www.youtube.com/watch?v=DpDyVFpoDSQ)
