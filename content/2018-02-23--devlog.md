...
Main feature of this release is abilities.
They come in two flavours: **active** and **passive**.

- Each active ability usage requires either **Attack** (red) or **Joker** (purple)
    point and can trigger enemy's reaction attack.
...
Exact abilities are explained in corresponding unit sections below.
